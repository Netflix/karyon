...
public class HttpServletRequestTest {
    ...
    public void testRequestedSessionId() throws Exception {
        ...
        request.nettyRequest().headers().add(HttpServletRequestImpl.COOKIE_HEADER_NAME, createJsessionIdCookieValue(sessionId));
    ...
    public void testCookies() throws Exception {
        HttpServletRequestImpl request = createServletRequest();
        request.nettyRequest().headers().add(HttpServletRequestImpl.COOKIE_HEADER_NAME, "a=b;c=d");
    ...
    public void testCookiesSingleParse() throws Exception {
        ...
        request.nettyRequest().headers().remove(HttpServletRequestImpl.COOKIE_HEADER_NAME); // Remove the cookie header so that it can be retrieved for second getCookie call.
    ...
    public void testInvalidDateHeader() throws Exception {
        ...
        servletRequest.nettyRequest().headers().add(headerName, "abc");
    ...
    public void testValidDateHeader() throws Exception {
        ...
        servletRequest.nettyRequest().headers().add(headerName, nowAsStr);
    ...
    public void testGetHeader() throws Exception {
        ...
        servletRequest.nettyRequest().headers().add(headerName, headerVal);
    ...
    public void testGetHeaderMultiValue() throws Exception {
        ...
        servletRequest.nettyRequest().headers().add(headerName, headerVals[0]);
        servletRequest.nettyRequest().headers().add(headerName, headerVals[1]);
    ...
    public void testGetHeaderNames() throws Exception {
        ...
        String[] headerVals = {"hey!!!", "hey123"};
        servletRequest.nettyRequest().headers().add(headerNames[0], headerVals[0]);
        servletRequest.nettyRequest().headers().add(headerNames[1], headerVals[1]);
    ...
    public void testExistingSession() throws Exception {
        ...
        newRequestWithOldSession.nettyRequest().headers().add(HttpServletRequestImpl.COOKIE_HEADER_NAME,
    ...
    public void testCharEncoding() throws Exception {
        HttpServletRequestImpl servletRequest = createServletRequest();
        servletRequest.nettyRequest().headers().set(HttpHeaders.Names.CONTENT_TYPE, "text/html");
        ...
        servletRequest.nettyRequest().headers().set(HttpHeaders.Names.CONTENT_TYPE, "text/html; charset=" + encoding);
    ...
    public void testContentType() throws Exception {
        ...
        servletRequest.nettyRequest().headers().set(HttpHeaders.Names.CONTENT_TYPE, contentType);
    ...
    public void testGetServerName() throws Exception {
        HttpServletRequestImpl servletRequest = createServletRequest();
        String host = "Me";
        servletRequest.nettyRequest().headers().add(HttpHeaders.Names.HOST, host);
    ...
    public void testLocales() throws Exception {
        ...
        servletRequest.nettyRequest().headers().set(HttpHeaders.Names.ACCEPT_LANGUAGE,
                                                    expectedPrimaryLocale.getLanguage() + ", "
                                                    + expectedSecondaryLocale.getLanguage() + '-'
                                                    + expectedSecondaryLocale.getCountry()
    ...
    private static HttpServletRequestImpl createServletRequest() {
