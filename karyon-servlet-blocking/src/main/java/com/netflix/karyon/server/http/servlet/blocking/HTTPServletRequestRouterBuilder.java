...
public class HTTPServletRequestRouterBuilder {
    ...
    public ServletAndFilterAttacher forUri(String uri) {
        ...
        ServletAndFilterAttacher attacher =
                new ServletAndFilterAttacher(new ServletStyleUriConstraintKey<ByteBuf>(uri, normalizedContextPathForAttachers));
    ...
    public ServletAndFilterAttacher forUriRegex(String regEx) {
        ...
        ServletAndFilterAttacher interceptorAttacher = new ServletAndFilterAttacher(new RegexUriConstraintKey<ByteBuf>(regEx));
    ...
    public ServletAndFilterAttacher forHttpMethod(HttpMethod method) {
        ...
        ServletAndFilterAttacher interceptorAttacher = new ServletAndFilterAttacher(new MethodConstraintKey<ByteBuf>(method));
        attachers.add(interceptorAttacher);
        return interceptorAttacher;
    }
    ...
    public HttpServletRequestRouter build() {
        ...
        return new HttpServletRequestRouter(contextPath, secure, holder);
    }

    public class ServletAndFilterAttacher {

        private final HttpInterceptorKey<ByteBuf> constraintKey;
        private Class<? extends HttpServlet> servletClass;
        private final LinkedList<Class<? extends Filter>> orderedFilters;

        ServletAndFilterAttacher(HttpInterceptorKey<ByteBuf> constraintKey) {
        ...
        HttpInterceptorKey<ByteBuf> getConstraintKey() {
