...
public class EurekaIntegrationTest {
    ...
    private void startServer() throws Exception {
        DefaultBootstrap.Builder builder = new DefaultBootstrap.Builder("eureka-integration-test", "test");
        SyncHealthCheckInvocationStrategy strategy = new SyncHealthCheckInvocationStrategy(AlwaysHealthyHealthCheck.INSTANCE);
        builder.serviceRegistryClient(new EurekaHandler.Builder(strategy).build());
        server = new KaryonServer(builder.build());
        server.start();
    }
