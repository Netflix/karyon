...
/**
 * Tests the {@link KaryonExtension} class.
 *
 * @author Jakub Narloch (jmnarloch@gmail.com)
 */
@RunWith(MockitoJUnitRunner.class)
public class KaryonExtensionTest {

    private KaryonExtension instance;
    ...
    /**
     * Tests the {@link KaryonExtension#register(LoadableExtension.ExtensionBuilder)} method.
     */
    @Test
    public void shouldRegisterExtension() {
        ...
        // then
        verify(extensionBuilder).service(AuxiliaryArchiveAppender.class, KaryonExtensionArchiveAppender.class);
        verify(extensionBuilder).observer(KaryonExtensionConfigrationProducer.class);
