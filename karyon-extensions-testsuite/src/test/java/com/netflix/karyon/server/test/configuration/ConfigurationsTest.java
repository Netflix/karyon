...
public class ConfigurationsTest {
    ...
    public void shouldReadConfigurationFromArquillianDescriptor() {
        ...
        // when
        KaryonExtensionConfiguration configuration = Configurations.fromDescriptor(descriptor).parse();
    ...
    public void shouldReadConfigurationFromProperties() throws IOException {
        ...
        try {
            // given
            input = new FileInputStream(new File("src/test/resources", "karyon-testsuite.properties"));

            // when
            KaryonExtensionConfiguration configuration = Configurations.fromProperties(input).parse();
    ...
    /**
     * Tests the {@link Configurations#toProperties(KaryonExtensionConfiguration)} method.
     *
     * @throws IOException if any error occurs
     */
    @Test
