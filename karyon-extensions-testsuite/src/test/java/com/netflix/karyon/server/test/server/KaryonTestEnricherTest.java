...
/**
 * Tests the {@link KaryonTestEnricher} class.
 *
 * @author Jakub Narloch (jmnarloch@gmail.com)
 */
public class KaryonTestEnricherTest {

    private KaryonTestEnricher instance;

    @Before
    public void setUp() {

        // given
        instance = new KaryonTestEnricher();
        ...
        KaryonTestGuiceContextListener.setServletContextInjector(injector);
    }

    /**
     * Test the {@link KaryonTestEnricher#enrich(Object)} method.
     */
    @Test
    ...
    /**
     * Test the {@link KaryonTestEnricher#enrich(Object)} method on a test instance that is not annotated with
     * {@link RunInKaryon}.
     */
    @Test
    ...
    /**
     * Test the {@link KaryonTestEnricher#enrich(Object)} method when there is no captured injector.
     */
    @Test(expected = RuntimeException.class)
    public void shouldThrowException() {

        // given
        KaryonTestGuiceContextListener.setServletContextInjector(null);
        TestCase testCase = new TestCase();
        assertNull("The dependency can not be null.", testCase.getComponent());
