...
/**
 * Tests the {@link KaryonServerInitializer} class.
 *
 * @author Jakub Narloch (jmnarloch@gmail.com)
 */
public class KaryonServerInitializerTest extends AbstractTestTestBase {

    /**
     * Represents the karyon property name.
     */
    ...
    private KaryonServerInitializer instance;
    ...
    protected void addExtensions(List<Class<?>> extensions) {
        extensions.add(KaryonServerInitializer.class);
    }
    ...
    public void setUp() {
        ...
        instance = new KaryonServerInitializer();
    ...
    /**
     * Tests the {@link KaryonServerInitializer#initializeProperties(BeforeClass)} method.
     */
    @Test
    public void shouldSetPropertiesFromAnnotation() {
        ...
        assertEquals("The property 'archaius.deployment.applicationId' hasn't been set.",
                "karyon-test", System.getProperty(APPLICATION_ID_PROPERTY_NAME));
    ...
    public void shouldSetPropertiesFromAnnotationWithDefaultEnvironment() {
        ...
        // then
        assertEquals("The property 'archaius.deployment.applicationId' hasn't been set.",
                "karyon-dev", System.getProperty(APPLICATION_ID_PROPERTY_NAME));
        assertEquals("The property 'archaius.deployment.environment' hasn't been set.",
    ...
    public void shouldSetPropertiesFromConfiguration() {
        ...
        configuration.setApplicationId("karyon-config");
        ...
        // then
        assertEquals("The property 'archaius.deployment.applicationId' hasn't been set.",
                "karyon-config", System.getProperty(APPLICATION_ID_PROPERTY_NAME));
        assertEquals("The property 'archaius.deployment.environment' hasn't been set.",
                "test", System.getProperty(ENVIRONMENT_PROPERTY_NAME));
    }
     ...
     * @author Jakub Narloch (jmnarloch@gmail.com)
     */
    @RunInKaryon(applicationId = "karyon-test", environment = "test")
     ...
     * @author Jakub Narloch (jmnarloch@gmail.com)
     */
    @RunInKaryon(applicationId = "karyon-dev")
