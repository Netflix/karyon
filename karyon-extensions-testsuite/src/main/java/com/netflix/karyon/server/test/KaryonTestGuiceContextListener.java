 ...
 */
public class KaryonTestGuiceContextListener extends KaryonGuiceContextListener {

    /**
     * The instance of the injector used by the Karyon.
     */
    ...
    public static synchronized Injector getServletContextInjector() {
        return KaryonTestGuiceContextListener.injector;
    }
    ...
    public static synchronized void setServletContextInjector(Injector injector) {
        KaryonTestGuiceContextListener.injector = injector;
    }
