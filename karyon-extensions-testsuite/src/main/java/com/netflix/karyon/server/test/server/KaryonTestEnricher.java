...
/**
 * The Arquillian test enricher, that is able to inject the Karyon configured components.
 * <p />
 * Basically this enricher injects all the Guice configured injection points.
 *
 * @author Jakub Narloch (jmnarloch@gmail.com)
 */
public class KaryonTestEnricher implements TestEnricher {

    /**
     * Enriches the test instance, by injecting all Karyon configured dependencies.
     *
    ...
    /**
     * Retrieves the Karyon configured injector from the servlet context.
     *
     * @return the injector
     */
    private Injector getServletContextInjector() {

        return KaryonTestGuiceContextListener.getServletContextInjector();
    }
}
