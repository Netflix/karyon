...
public final class Configurations {
    ...
    /**
     * The name of the property indicating whether the karyon classes should be package.
     */
    private static final String AUTO_PACKAGE = "autoPackage";
     ...
     * @return the {@link ConfigurationParser}
     */
    public static ConfigurationExporter toProperties(KaryonExtensionConfiguration configuration) {
     ...
     * @author Jakub Narloch (jmnarloch@gmail.com)
     */
    private static final class ArquillianDescriptorConfigurationParser implements ConfigurationParser {

        /**
         * Represents the extension configuration name within the arquillian descriptor.
         */
        private static final String KAYRON_EXTENSION = "karyon";
         ...
         */
        @Override
        public KaryonExtensionConfiguration parse() {

            Map<String, String> properties = getExtensionProperties();
            KaryonExtensionConfiguration configuration = new KaryonExtensionConfiguration();
            configuration.setApplicationId(properties.get(APPLICATION_ID));
            configuration.setEnvironment(properties.get(ENVIRONMENT));
            String autoPackage = properties.get(AUTO_PACKAGE);
            if (autoPackage != null) {
                configuration.setAutoPackage(Boolean.parseBoolean(autoPackage));
            } else {
    ...
    private static class PropertiesConfigurationParser implements ConfigurationParser {
        ...
        public KaryonExtensionConfiguration parse() {
            ...
            KaryonExtensionConfiguration configuration;
            ...
            try {
                ...
                String autoPackage = properties.getProperty(AUTO_PACKAGE);
                if (autoPackage != null) {
                    configuration.setAutoPackage(Boolean.parseBoolean(autoPackage));
                } else {
                    configuration.setAutoPackage(false);
    ...
    private static class PropertiesConfigurationExporter implements ConfigurationExporter {
        ...
        /**
         * The karyon configuration.
         */
        private final KaryonExtensionConfiguration configuration;
         ...
         */
        public PropertiesConfigurationExporter(KaryonExtensionConfiguration configuration) {
        ...
        public String exportAsString() {
            ...
            try {
                ...
                put(properties, AUTO_PACKAGE, String.valueOf(configuration.isAutoPackage()));

                StringWriter writer = new StringWriter();
                properties.store(writer, "karyon-testsuite properties");
