 ...
 */
public class KaryonExtension implements LoadableExtension {
    ...
    public void register(ExtensionBuilder builder) {
        ...
        builder.service(AuxiliaryArchiveAppender.class, KaryonExtensionArchiveAppender.class)
                .observer(KaryonExtensionConfigrationProducer.class);
    }
}
