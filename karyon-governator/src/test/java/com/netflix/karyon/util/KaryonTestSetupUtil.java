 ...
 * @author Nitesh Kant
 */
public final class KaryonTestSetupUtil {

    private KaryonTestSetupUtil() {
    }
    ...
    public static Injector startServer(KaryonServer server, KaryonGovernatorBootstrap bootstrap) throws Exception {
        server.start();
