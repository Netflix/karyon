 ...
 * {@link Component#disableProperty()} for details on how to disable a component from being
 * initialized. <br/>
 * If you want to hand-pick the components to be initialized, set a property {@link com.netflix.karyon.server.bootstrap.PropertyNames#EXPLICIT_COMPONENT_CLASSES_PROP_NAME}
...
public @interface Component {
     ...
     * {@link com.netflix.karyon.server.bootstrap.PropertyNames#COMPONENT_DISABLE_PROP_PEFIX}.[classname of the component], which if set to true, will
